...
import br.com.fabiohb.spring.jpajdbitest.persistence.JdbcBusinessEntityRepository;

@RestController
@RequestMapping("/jdbi/business-entity")
@Scope(BeanDefinition.SCOPE_SINGLETON)
public class JdbcBusinessEntityResource extends GenericResource {

	@Autowired
	private JdbcBusinessEntityRepository repository;
